...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
FUNCTION CALSPEC_TEMP2, FILE, PEAKSFILE = PEAKSFILE, THR = THR, BINWIDTH = BINWIDTH, $
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  if not keyword_set(thr) then thr=4.0
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
if data[i].asic eq 0 and (data[i].cmn_median lt 8 or data[i].packet_error gt 10) then data[i].error_flag=1
if data[i].asic eq 1 and (data[i].cmn_median lt 8 or data[i].packet_error gt 10) then data[i].error_flag=1
if data[i].asic eq 2 and (data[i].cmn_median gt 90 or data[i].packet_error gt 10) then data[i].error_flag=1
if data[i].asic eq 3 and (data[i].cmn_median gt 90 or data[i].packet_error gt 10) then data[i].error_flag=1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        if asic lt 4 and data[i].error_flag eq 0 then begin
            ...
            for ch = 0, 63 do begin
                ...
                if badch[asic,ch] eq 0 and edep gt thr and abs(data[i].data[ch]-cmn[i]-257) gt 10 then begin
                    hitchnum+=1
                    hitch=ch
                endif
