...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
PRO PEAKS_FE_NI_CU_AM_CR_gauss_detpos6, HISTFE=HISTFE, HISTAMNI=HISTAMNI,HISTAMCU=HISTAMCU, HISTAME=HISTAME, HISTCR=HISTCR
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
for asic=0, 1 do begin
	...
	;peaks(3, ch, asic, 0)=find_peak(xxamni,yyamni,50,80,2, 8)
	peaks(4, ch, asic, 0)=find_peak(xxamcu,yyamcu,60,85,2, 8)
	...
	gauss_peak=find_gauss(xxam,yyam, 350,450,1,2)
	...
	;gauss_peak=find_gauss(xxcr,yycr, 28,50,1,2)
        gauss_peak=find_gauss(xxcr,yycr, 32,peaks(2,ch,asic,0)-7,1,2)
	peaks(8, ch, asic, 0)=gauss_peak[0]
	error(8, ch, asic, 0)= gauss_peak[1]
	;if(peaks(8,ch,asic,0) le 32.) then begin
        ;gauss_peak=find_gauss(xxcr,yycr, 28,peaks(2,ch,asic,0)-7,1,1)
	;    peaks(8, ch, asic, 0) = 39.
...
for asic=2, 3 do begin
	...
	xxcr=histcr(*, ch, asic,0)
        ...
        ;peaks(*, ch, asic, 1)=[0.0,0.0,5.895,7.47,8.26,8.04,8.91,13.93,17.611,20.9,59.54,0.0]
        ;peaks(*, ch, asic,1)=[0.0,0.0,5.895,7.47,8.04,13.93,17.611,20.9,26.34,59.54,0.0]
	...
	gauss_peak=find_gauss(xxfe,yyfe, 40,80,1, 1)
	peaks(2, ch, asic, 0)=gauss_peak[0]
	error(2, ch, asic, 0)= gauss_peak[1]

	;peaks(3, ch, asic, 0)=find_peak(xxamni,yyamni, 50,85,3, 6)
        gauss_peak=find_gauss(xxamni,yyamni, 50,90,2,2)
	...
	gauss_peak=find_gauss(xxam,yyam, 180,215,1,1)
	peaks(6, ch, asic, 0)=gauss_peak[0]
	error(6, ch, asic, 0)= gauss_peak[1]
	...
	gauss_peak=find_gauss(xxam,yyam, 215,265,1,1)
	peaks(7, ch, asic, 0)=gauss_peak[0]
	error(7, ch, asic, 0)= gauss_peak[1]

	;peaks(8, ch, asic, 0)=find_peak(xxam,yyam,260,290,3,2)

	gauss_peak=find_gauss(xxam,yyam, 280,325,2,2)
	peaks(8, ch, asic, 0)=gauss_peak[0]
	error(8, ch, asic, 0)= gauss_peak[1]


	;peaks(9, ch, asic, 0)=find_peak(xxam,yyam,680,750,2,8)
	gauss_peak=find_gauss(xxam,yyam, 700,800,2,4)
