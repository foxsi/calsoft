...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  i0 = where(data.asic eq 0 and data.error_flag eq 0 and data.cmn_median gt 8)
  i1 = where(data.asic eq 1 and data.error_flag eq 0 and data.cmn_median gt 8)
  i2 = where(data.asic eq 2 and data.error_flag eq 0 and data.cmn_median lt 90)
  i3 = where(data.asic eq 3 and data.error_flag eq 0 and data.cmn_median lt 60)
