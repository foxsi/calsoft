...
FUNCTION	FOXSI_LEVEL0_TO_LEVEL1_cdte, FILENAME, DETECTOR=DETECTOR, STOP=STOP, $
			GROUND=GROUND
	...
	data_struct[i0].assoc_adc[*,0,0] = 63 - reform(data0[i0].adc[0,*] )
	data_struct[i0].assoc_adc[*,1,0] = 63 - reform(data0[i0].adc[0,*] )
	data_struct[i0].assoc_adc[*,2,0] = 63 - reform(data0[i0].adc[0,*] )

	data_struct[i0].unrel_adc[*,0,0] = 127 - reform(data0[i0].adc[1,*] )
	data_struct[i0].unrel_adc[*,1,0] = 127 - reform(data0[i0].adc[1,*] )
	data_struct[i0].unrel_adc[*,2,0] = 127 - reform(data0[i0].adc[1,*] )

	data_struct[i0].assoc_xy[*,0,1] = reform(data0[i0].strips[0,*] )
	data_struct[i0].assoc_xy[*,1,1] = reform(data0[i0].strips[0,*] )
	data_struct[i0].assoc_xy[*,2,1] = reform(data0[i0].strips[0,*] )

	data_struct[i0].unrel_xy[*,0,1] = 64 + reform(data0[i0].strips[1,*] )
	data_struct[i0].unrel_xy[*,1,1] = 64 + reform(data0[i0].strips[1,*] )
	data_struct[i0].unrel_xy[*,2,1] = 64 + reform(data0[i0].strips[1,*] )
	; ---------------------
	...
	data_struct[i1].assoc_adc[*,0,0] = 63 - reform(data0[i1].adc[1,*] )
	data_struct[i1].assoc_adc[*,1,0] = 63 - reform(data0[i1].adc[1,*] )
	data_struct[i1].assoc_adc[*,2,0] = 63 - reform(data0[i1].adc[1,*] )

	data_struct[i1].unrel_adc[*,0,0] = 127 - reform(data0[i1].adc[0,*] )
	data_struct[i1].unrel_adc[*,1,0] = 127 - reform(data0[i1].adc[0,*] )
	data_struct[i1].unrel_adc[*,2,0] = 127 - reform(data0[i1].adc[0,*] )

	data_struct[i1].assoc_xy[*,0,1] = reform(data0[i1].strips[1,*] )
	data_struct[i1].assoc_xy[*,1,1] = reform(data0[i1].strips[1,*] )
	data_struct[i1].assoc_xy[*,2,1] = reform(data0[i1].strips[1,*] )

	data_struct[i1].unrel_xy[*,0,1] = 64 + reform(data0[i1].strips[0,*] )
	data_struct[i1].unrel_xy[*,1,1] = 64 + reform(data0[i1].strips[0,*] )
	data_struct[i1].unrel_xy[*,2,1] = 64 + reform(data0[i1].strips[0,*] )
	; ---------------------
	...
	data_struct[i2].assoc_adc[0,*,1] = 63 - data0[i2].adc[2,*]
	data_struct[i2].assoc_adc[1,*,1] = 63 - data0[i2].adc[2,*]
	data_struct[i2].assoc_adc[2,*,1] = 63 - data0[i2].adc[2,*]

	data_struct[i2].unrel_adc[0,*,1] = 127 - data0[i2].adc[3,*]
	data_struct[i2].unrel_adc[1,*,1] = 127 - data0[i2].adc[3,*]
	data_struct[i2].unrel_adc[2,*,1] = 127 - data0[i2].adc[3,*]

	data_struct[i2].assoc_xy[0,*,0] = data0[i2].strips[2,*]
	data_struct[i2].assoc_xy[1,*,0] = data0[i2].strips[2,*]
	data_struct[i2].assoc_xy[2,*,0] = data0[i2].strips[2,*]

	data_struct[i2].unrel_xy[0,*,0] = 64 + data0[i2].strips[3,*]
	data_struct[i2].unrel_xy[1,*,0] = 64 + data0[i2].strips[3,*]
	data_struct[i2].unrel_xy[2,*,0] = 64 + data0[i2].strips[3,*]
	...
	data_struct[i3].assoc_adc[0,*,1] = 63 - data0[i3].adc[3,*]
	data_struct[i3].assoc_adc[1,*,1] = 63 - data0[i3].adc[3,*]
	data_struct[i3].assoc_adc[2,*,1] = 63 - data0[i3].adc[3,*]

	data_struct[i3].unrel_adc[0,*,1] = 127 - data0[i3].adc[2,*]
	data_struct[i3].unrel_adc[1,*,1] = 127 - data0[i3].adc[2,*]
	data_struct[i3].unrel_adc[2,*,1] = 127 - data0[i3].adc[2,*]

	data_struct[i3].assoc_xy[0,*,0] = data0[i3].strips[3,*]
	data_struct[i3].assoc_xy[1,*,0] = data0[i3].strips[3,*]
	data_struct[i3].assoc_xy[2,*,0] = data0[i3].strips[3,*]

	data_struct[i3].unrel_xy[0,*,0] = 64 + data0[i3].strips[2,*]
	data_struct[i3].unrel_xy[1,*,0] = 64 + data0[i3].strips[2,*]
	data_struct[i3].unrel_xy[2,*,0] = 64 + data0[i3].strips[2,*]
	; ---------------------
	...
	data_struct[i0].hit_xy_det[1] = 63 - data0[i0].hit_strip[0]
	data_struct[i1].hit_xy_det[1] = 127 - data0[i1].hit_strip[0]
	if i2[0] ne -1 then data_struct[i2].hit_xy_det[0] = 127 - data0[i2].hit_strip[1]
	data_struct[i3].hit_xy_det[0] = 63 - data0[i3].hit_strip[1]
